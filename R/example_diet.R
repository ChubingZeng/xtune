...
#' and an binary outcome, weightloss. The external information Z is the nuitrition fact about the dietary items.
...
#' \item NuitritionFact: External information of the predictors
#' }
